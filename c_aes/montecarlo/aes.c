...
{int i;
  unsigned char buf1, buf2, buf3, round,temp;
...
////////////////////////////////////////////////
	...
	printf("KEY %d: ",round);
		for (i=0; i<16; i++)
		printf("%2x", expandedKey[(round*16) +  i]);
	printf("\n");
	}
	{
	...
	printf("encrypt--------------------- %d: ",round);
		for (i=0; i<16; i++){
		temp = state[i] ^ expandedKey[((round+1)*16) +  i];
		printf("%2x", temp);}
	printf("\n");
	*/
////////////////////////////////////////////
...
int main( )
{
	...
	unsigned char key[] = {0x8d, 0x2e, 0x60, 0x36, 0x5f, 0x17, 0xc7, 0xdf, 0x10, 0x40, 0xd7, 0x50, 0x1b, 0x4a, 0x7b, 0x5a};
	unsigned char pt[]   = {0x59, 0xb5, 0x08, 0x8e, 0x6d, 0xad, 0xc3, 0xad, 0x5f, 0x27, 0xa4, 0x60, 0x87, 0x2d, 0x59, 0x29};
