...
void Sender()
{
	int idx,jdx,k;
	k=0;
	key_values[0] = 0x00000001;
	key_values[1] = 0x00000000;
	key_values[2] = 0x00000000;
	key_values[3] = 0x00000000;
	key_values[4] = 0x00000000;
	sent_values[0] = 0x80000000;
	sent_values[1] = 0x00000000;
	sent_values[2] = 0x00000000;
	sent_values[3] = 0x00000000;
	//printf("\nPT: %8x %8x %8x %8x",sent_values[0],sent_values[1],sent_values[2],sent_values[3]);
	write_uint32_n("in_data",key_values,5);
