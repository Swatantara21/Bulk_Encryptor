...
############ RIFFA 2.2.0 HDL ############
read_verilog [glob ../hdl_250/riffa_hdl/*.v] 
read_verilog [glob ../hdl_250/*.v]


########## RIFFA TO CPU BRIDGE ##########
read_verilog ../hdl_250/riffa_cpu_bridge.v
read_vhdl ../hdl_250/DualClockedQueue.vhdl
...
read_vhdl ../ahir_files/aesv2_6/ahir_system_global_package.vhdl
read_vhdl ../ahir_files/aesv2_6/ahir_system.vhdl


############### SYNTHESIZE ##############
#set outputDir ./results
#file mkdir $outputDir
synth_design -top KC705_Gen1x8If64 -part xc7k325tffg900-2 -include_dirs ../hdl_250/riffa_hdl/
